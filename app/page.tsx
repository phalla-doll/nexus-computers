...
const products = [
  ...
  { id: 13, name: 'VANGUARD ELITE', desc: 'GAMING BEAST', price: '$3,800', image: 'https://picsum.photos/seed/pc7/600/400' },
  { id: 14, name: 'ZENITH BOOK', desc: 'EXECUTIVE', price: '$2,100', image: 'https://picsum.photos/seed/laptop6/600/400' },
  { id: 15, name: 'APEX TOWER', desc: 'CUSTOM LOOP', price: '$6,200', image: 'https://picsum.photos/seed/pc8/600/400' },
  { id: 16, name: 'OMNIS AI', desc: 'DATA SCIENCE', price: '$9,500', image: 'https://picsum.photos/seed/server2/600/400' },
  { id: 17, name: 'STEALTH SLIM', desc: 'PORTABLE', price: '$1,400', image: 'https://picsum.photos/seed/laptop7/600/400' },
  { id: 18, name: 'NEXUS NODE', desc: 'MINI ITX', price: '$1,800', image: 'https://picsum.photos/seed/pc9/600/400' },
  { id: 19, name: 'AURA VISION', desc: 'COLOR ACCURATE', price: '$3,100', image: 'https://picsum.photos/seed/laptop8/600/400' },
  { id: 20, name: 'QUANTUM CORE', desc: 'SILENT BUILD', price: '$2,600', image: 'https://picsum.photos/seed/pc10/600/400' },
  { id: 21, name: 'ECHO FLEX', desc: '2-IN-1 CONVERTIBLE', price: '$1,350', image: 'https://picsum.photos/seed/laptop9/600/400' },
  { id: 22, name: 'TITAN FORGE', desc: '3D MODELING', price: '$4,800', image: 'https://picsum.photos/seed/pc11/600/400' },
  { id: 23, name: 'VANGUARD LITE', desc: 'ESPORTS READY', price: '$1,500', image: 'https://picsum.photos/seed/pc12/600/400' },
  { id: 24, name: 'ZENITH FOLD', desc: 'FOLDABLE SCREEN', price: '$3,400', image: 'https://picsum.photos/seed/laptop10/600/400' },
  { id: 25, name: 'APEX MICRO', desc: 'SFF BUILD', price: '$2,200', image: 'https://picsum.photos/seed/pc13/600/400' },
  { id: 26, name: 'OMNIS CLUSTER', desc: 'RENDER FARM', price: '$12,000', image: 'https://picsum.photos/seed/server3/600/400' },
  { id: 27, name: 'STEALTH RIG', desc: 'STREAMER EDITION', price: '$3,600', image: 'https://picsum.photos/seed/pc14/600/400' },
  { id: 28, name: 'NEXUS SPHERE', desc: 'CONCEPT DESIGN', price: '$5,500', image: 'https://picsum.photos/seed/pc15/600/400' },
  { id: 29, name: 'AURA CANVAS', desc: 'TOUCH SCREEN', price: '$2,700', image: 'https://picsum.photos/seed/laptop11/600/400' },
  { id: 30, name: 'QUANTUM X', desc: 'FLAGSHIP', price: '$7,000', image: 'https://picsum.photos/seed/pc16/600/400' },
];
